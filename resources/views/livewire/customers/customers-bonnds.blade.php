                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 class=" overflow-x-auto"">
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700 overflow-x-auto  style=" width: 99%;>
                            ...
                            <tr>
                                ...
                                {{ $customersBond->created_at->format('H:i') }}
                            </td>

                                <td class="px-6 py-4 whitespace-nowrap text-end text-bold font-medium">
                                    <button type="button" class="text-danger hover:text-sky-700 mt-5 " data-fc-target="#modal-{{ $customersBond->id }}" data-fc-type="modal" type="button" style="font-size: larger; font-weight: bolder;">مسح</button><br>
                                    <a href="{{ route('customerBondPrint', $customersBond->id) }}" class="text-primary hover:text-sky-700 mt-5">طباعة</a>
                                    <div id="modal-{{ $customersBond->id }}" class="w-full h-full mt-5 fixed top-0 left-0 z-50 transition-all duration-500 fc-modal hidden">
