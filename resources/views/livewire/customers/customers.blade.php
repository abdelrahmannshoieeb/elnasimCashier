                ...
                <div class="overflow-hidden">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 class=" overflow-x-auto"">
                        <thead class="bg-gray-50 dark:bg-gray-700">
                            <tr>
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase text-center" style="font-size: larger; font-weight: bolder">المسلسل </th>
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase text-center" style="font-size: larger; font-weight: bolder">الترتيب </th>
                                ...
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase text-center" style="font-size: larger; font-weight: bolder">العميل ما زال عليه</th>
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-gray-200 text-center">{{ $loop->iteration }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200 text-center" style="font-size: larger; font-weight: bolder">
                                    <a href="{{ route('customerDetails', $customer->id) }}">{{ $customer->name }}</a>
                                </td>
                                @if ($customer->address)
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                                    <button type="button"
                                        class="text-danger hover:text-sky-700 mt-5"
                                       data-fc-target="#modal-{{ $customer->id }}"
                                        data-fc-type="modal"
                                    ...
                                    <br>
                                    <a href="{{ route('editCustomer', $customer->id) }}" type="button" class="text-info hover:text-sky-700 mt-5" style="font-size: larger; font-weight: bolder;">تعديل</a>
                                    <div id="modal-{{ $customer->id }}"
                                        class="w-full h-full mt-5 fixed top-0 left-0 z-50 transition-all duration-500 fc-modal hidden">
                                        <div class="sm:max-w-lg sm:w-full m-3 sm:mx-auto flex flex-col bg-white border shadow-sm rounded-md">
                                            ...
                                            <div class="flex justify-end items-center gap-4 p-4 border-t">
                                                <button class="btn border hover:bg-gray-100" data-fc-dismiss type="button">الغاء</button>
                                                <button class="btn text-white font-bold border hover:bg-red-600 transition-all"
                                                    data-fc-dismiss
                                                    type="button"
