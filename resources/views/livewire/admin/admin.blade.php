        ...
        <div class="lg:col-span-3 space-y-6">
            <div class="card p-6">
                <div class="flex justify-between items-center mb-4">
                    <p class="card-title">تغيير بيانات تسجيل الدخول</p>
                ...
                <div class="flex flex-col gap-3">
                    ...
                    <div class="">
                        <label for="project-name" class="mb-2 block " style="font-weight:600;">كلمة المرور</label>
                        <input style="font-weight:600;" type="password" id="project-name" class="form-input" type="password"
                          wire:model="password">
                    </div>
                </div>
            </div>
