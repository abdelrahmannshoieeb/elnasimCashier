            ...
            <div class="card p-6">
                ...
                <div class="flex flex-col gap-3">
                    ...
                    <div class="">
                        ...
                        <textarea id="project-description" class="form-input" rows="8" placeholder="{{ $product->description }}" wire:model="description"></textarea>
                    ...
                    <div class="grid md:grid-cols-4 gap-3">
                        <div class="">
                            ...
                            <input type="text" id="start-date" class="form-input" placeholder="{{ $product->price1 }}" wire:model="price1"></input>
                        ...
                        <div class="">
                            ...
                            <input type="text" id="due-date" placeholder="{{ $product->price2 }}"  class="form-input" wire:model="price2"></input>
                        ...
                        <div class="">
                            ...
                            <input type="text" id="due-date" placeholder="{{ $product->price3 }}" class="form-input" style="font-weight:600;" wire:model="price3"></input>
                        ...
                        <div class="">
                            ...
                            <input type="text" id="due-date" class="form-input" placeholder="{{ $product->buying_price }}" style="font-weight:600;" wire:model="buying_price"></input>
                    ...
                    <div class="grid md:grid-cols-4 gap-3">
                        <div class="">
                            ...
                            <input type="text" id="start-date" placeholder="{{ $product->itemStock }}" class="form-input" style="font-weight:600;" wire:model="itemStock"></input>
                        ...
                        <div class="">
                            ...
                            <input type="text" id="due-date" placeholder="{{ $product->PacketStock }}" class="form-input" style="font-weight:600;" wire:model="PacketStock"></input>
                        ...
                        <div class="">
                            ...
                            <input type="text" id="due-date" placeholder="{{ $product->items_in_packet }}" class="form-input" style="font-weight:600;" wire:model="items_in_packet"></input>
                        ...
                        <div class="">
                            ...
                            <input type="text" placeholder="{{ $product->stockAlert }}" id="due-date" class="form-input" style="font-weight:600;" wire:model="stockAlert"></input>
