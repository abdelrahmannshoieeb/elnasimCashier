        ...
        <ul class="menu" data-fc-type="accordion">
            ...
            <li class="menu-item">
                <a href="{{ route('addInvoice')}}" class="menu-link">
                    ...
                    <span class="menu-text font-bold">  اضافة فواتير لعميل</span>
                </a>
            </li>
            <li class="menu-item">
                <a href="{{ route('addSupplierInvoice')}}" class="menu-link">
                    <span class="menu-icon"><i class="mgc_coupon_line"></i></span>
                    <span class="menu-text font-bold">  اضافة فواتير لمورد</span>
                </a>
            </li>
            <li class="menu-item">
            ...
            <li class="menu-title">تغيير كلمة السر</li>

            <li class="menu-item">
                <a href="javascript:void(0)" data-fc-type="collapse" class="menu-link">
                    <span class="menu-icon"><i class="mgc_user_3_line"></i></span>
                    <span class="menu-text"> تغيير كلمة السر </span>
                    <span class="menu-arrow"></span>
                </a>
